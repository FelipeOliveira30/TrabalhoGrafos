...
class GrafoDir : public Grafo {
    public:
        ...
        int VerificaConexidade();
        void Gera_ComponentesFortementeConexas();
        void Gera_ComponentesFortementeConexasAux(int vertice, int indice[], int low[], bool naPilha[], std::stack<int>& pilha, int& indiceAtual, int& componentesConexas);
};
